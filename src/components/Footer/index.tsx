      ...
      <div className="container">
        <div className="row">
          <div className="col-md-6 col-lg-3 col-xl-3 col-6">
            <ul className="footer-no-icons-list">
              <li className="list-heading">
                Site <span className="list-heading-strong">Links</span>
              </li>
          ...
          <div className="col-md-6 col-lg-3 col-xl-3 col-6">
            <ul className="footer-no-icons-list">
              <li className="list-heading">
                Other <span className="list-heading-strong">Links</span>
              </li>
          ...
          <div className="col-md-6 col-lg-3 col-xl-3 col-6">
            <ul className="footer-no-icons-list">
              <li className="list-heading">
                Share <span className="list-heading-strong">website</span>
              </li>
              <li>
          ...
          <div className="col-md-6 col-lg-3 col-xl-3 col-6">
            <ul className="footer-no-icons-list">
              <li className="list-heading">
                Website <span className="list-heading-strong">License</span>
              </li>
              <li>
                The code of this website is Open Sourced. This website is
                protected under GNU General Public License.
              </li>
              <li>&nbsp;</li>
              <li>
                <a href={app["license-link"].href} id={app["license-link"].id}>
                  {app["license-link"].text}
                  <span id={`${app["license-link"].id}-span`}></span>
                </a>
              </li>
            </ul>
          </div>
              ...
              {app.policy_links.map((link, index) => (
                <li key={index}>
                  <a href={link.href} id={link.id}>
                    {link.text} <span id={`${link.id}-span`}></span>
                  </a>
                </li>
              ))}
              {app["old-versions"].length ? (
                ...
                >
                  {oldVersionDropdownOpen && (
                    ...
                    >
                      ...
                      {app["old-versions"].map((version, index) => (
                        <a
                          key={index}
                          className="dropdown-item old-version-links"
                          href={`${app.app_url}${version.href}`}
                        >
                          {version.text}
                        </a>
                      ))}
                  ...
                  <button
                    ...
                    aria-expanded="false"
                    onClick={() =>
                      setOldVersionDropdownOpen(!oldVersionDropdownOpen)
                    }
                  >
                    <span>
                      <i
                        ...
                        data-toggle="tooltip"
                        data-placement="top"
                        title="Version selection will only work form the latest version. Please come back here to select and view different old version of this site."
                      ></i>
                      {` `}Version: {app["active-version"]}
                    </span>
                  </button>
                </div>
              ) : (
                <li>
                  <a href="#image-back-main" id={app["active-version"]}>
                    Version: {app["active-version"]}{" "}
                    <span id={`${app["active-version"]}-span`}></span>
                  </a>
                </li>
              )}
            </ul>
