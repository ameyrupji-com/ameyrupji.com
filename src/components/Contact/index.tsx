    ...
    const handleSubmit = async (event: Event) => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          alertBox.innerHTML =
            '<i class="fas fa-circle-notch fa-spin"></i> Your message has been successfully sent! I will get back at my earliest convenience.';
        } else {
        ...
        alertBox.innerHTML =
          '<i class="fas fa-circle-notch fa-spin"></i> Error sending your message! I have taken a note of this and will try to fix this ASAP.';
      } finally {
      ...
      <div className="container">
        ...
        >
          <div className="col-md-12 text-center">
            <h1 className="title">
              {contact["title-light"]}{" "}
              <span className="title-strong">{contact["title-strong"]}</span>
            </h1>
          </div>
        </div>
        <div
        ...
        >
                ...
                if (field.element === "input") {
                  ...
                  return (
                    <button
                      className={field["css-class"]}
                      type={
                        field.type as React.ButtonHTMLAttributes<HTMLButtonElement>["type"]
                      }
                      id={field["css-id"]}
                      key={index}
                    >
          ...
          <div
            className="col-md-4 col-lg-4 col-xl-4 offset-xl-1 col-12"
            id="contact-follow"
          >
            <div className="text-center">
              <h2 className="title">
